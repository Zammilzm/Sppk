    ...
    <div id="sidebar">
      <div id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav">
          ...
          <li class="active"><a href="<?php echo site_url('admin/c_admin/kritik')?>"><i class="fa fa-fw fa-wrench"></i><span>Kritik dan Saran</span></a></li>
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            <div class="navbar-header">
              ...
              <a class="navbar-brand text-size-24" href="#"><i class="fa fa-star-o"></i> Kritik dan Saran User</a>
            </div>
          </div>
        </nav>
      </div>
