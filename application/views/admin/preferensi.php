		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<a href="<?php echo site_url('admin/c_admin/form_tambah_lahan')?>" style="text-decoration:none">
					<button class="btn btn-primary bold">Tambah Lahan</button>
				</a>
				<br><br>
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="<?php echo site_url('admin/c_altertatif/edit/'.$u->id_alternatif,'Hapus') ?>"><button class="btn btn-success bold">Edit</button></a>
								<a href="<?php echo site_url('admin/c_altertatif/hapus/'.$u->id_alternatif,'Hapus') ?>"><button class="btn btn-danger bold">Hapus</button></a>
							</td>
						</tr>
						<?php } ?>
