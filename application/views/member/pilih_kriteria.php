...
<body>
	...
	<div class="container-fluid">
		<form method="POST" action="<?php echo site_url('member/c_promethee/hitung_prediksi')?>">
			<div class="row">
				<div class="col-sm-6  col-md-offset-3">
					...
					<table class="table tbl-detail">
						<tr>
							...
							<td>Luas Lahan</td>
							<td>
								<input name="luas" value="1" type="radio">0<=10 Ha
							</td>
							<td>
								<input name="luas" value="2" type="radio"><=20Ha
							</td>
							<td>
								<input name="luas" value="3" type="radio">lebih dari 20 Ha
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>Harga Lahan</td>
							<td>
								<input name="harga" value="3" type="radio">100-200 Juta
							</td>
							<td>
								<input name="harga" value="2" type="radio">200-300 Juta
							</td>
							<td>
								<input name="harga" value="1" type="radio">lebih dari 300Jt
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input name="ketinggian" value="1" type="radio">500-900 mdpl
							</td>
							<td>
								<input name="ketinggian" value="2" type="radio">901-1200 mdpl
							</td>
							<td>
								<input name="ketinggian" value="3" type="radio">lebih dari 1200 mdpl
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>Suhu</td>
							<td>
								<input name="suhu" value="1" type="radio">24-26
							</td>
							<td>
								<input name="suhu" value="2" type="radio">21-23
							</td>
							<td>
								<input name="suhu" value="3" type="radio">18-20
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>akses</td>
							<td>
								<input name="akses" value="1" type="radio">Sulit
							</td>
							<td>
								<input name="akses" value="2" type="radio">Sedang
							</td>
							<td>
								<input name="akses" value="3" type="radio">Mudah
							</td>
						</tr>
					</table>
					<hr>
